      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Sign in with 1-Click Google Single Sign-On to manage your daily tasks
          </p>
        </div>
        ...
        <div className="glass-panel p-8 rounded-3xl border border-gray-200/80 dark:border-gray-800 shadow-2xl space-y-5">
          ...
          {/* 1-Click Google Sign-In Primary Button */}
          <button
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-6">
          🔒 Secure 1-Click Google Single Sign-On Authentication
        </p>
      </div>
    </div>
  );
